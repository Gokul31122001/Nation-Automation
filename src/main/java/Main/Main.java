...
public class Main  extends JFrame{
	    ...
	    // ✅ Updated main() — detects headless mode for Render
	    public static void main(String[] args) {
	        try {
	            if (GraphicsEnvironment.isHeadless()) {
	                System.out.println("🚀 Running in headless mode — GUI disabled for Render.");
	                Webserver.start(); // Start minimal web service for Render
	            } else {
	                System.out.println("🖥️ GUI mode detected — launching Swing interface...");
	                new Main();
	            }
	        } catch (Exception e) {
	            e.printStackTrace();
